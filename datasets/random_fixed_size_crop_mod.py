    ...
    def transform_source_batch(self, source, source_name):
        ...
        if (isinstance(source, list) or
            ...
            if self.center_crop:  # deterministic center crop
                ...
                if (image_height - windowed_height) % 2 and (image_width - windowed_width) % 2: ### Warning: not considered all situations
                    out = source[:, :, offset_y+1:-offset_y, offset_x+1:-offset_x]
                else:
